...
<tbody>
    <tr style="width: 100%; float: left;">
        ...
        <td>{{ Form::select('company_id', $company_options) }}</td>
    </tr>
    <tr style="width: 100%; float: left;">
        <td style="width: 45%;">{{ Form::label('contract_id', 'Contract') }}</td>
        <td><select id="contract_id" name="contract_id">
                <option value="{{{$servicereport->contract_id}}}"></option>
            </select>
        </td>
    </tr>
</tbody></table>
...
<tbody>
    <tr style="width: 100%; float: left;">
        ...
        <td>{{ Form::select('internal', array('default' => $servicereport->internal,'0' => '0 = No','1' => '1 = Yes'), 'Default') }}</td>
    </tr>
    <tr style="width: 100%; float: left;">
        <td style="width: 45%;">{{ Form::label('free', 'Free?') }}</td>
        <td>{{ Form::select('free', array('default' => $servicereport->free,'0' => '0 = No','1' => '1 = Yes'), 'Default') }}</td>            
    </tr>
</tbody></table>
...
<tbody>
    ...
    <tr style="width: 100%; float: left;">
        ...
        <td style="border: none;">{{ link_to_route('servicereports.show', 'Cancel', $servicereport->id, array('class' => 'btn')) }}</td>
...
<input id="duration" type="hidden"  name="duration" value="{{{$servicereport->duration}}}">
<input id="utilizador_id" type="hidden"  name="utilizador_id" value="{{{$servicereport->utilizador_id}}}">
